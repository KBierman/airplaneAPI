...
public class SecurityConfig{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http.csrf().disable()
                ...
                .antMatchers("/api/flights/{fltno}").permitAll()
                .antMatchers(HttpMethod.POST, "/api/flight/{fltno}").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/flight/{fltno}").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/flight/{fltno}").permitAll()
